...
BEGIN
	...
	WHERE TimestampInizio > CURRENT_DATE - INTERVAL 1 YEAR AND C.TimestampFine IS NOT NULL
	...
	WHERE TimestampInizio > CURRENT_DATE - INTERVAL 1 YEAR AND NomeAbbonamento IS NOT NULL
